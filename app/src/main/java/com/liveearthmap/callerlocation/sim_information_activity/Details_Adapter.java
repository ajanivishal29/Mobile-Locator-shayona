...
public class Details_Adapter extends RecyclerView.Adapter<Details_Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int i) {
        myViewHolder.txtTitle.setText(realocation_SimInfo_Activity.arr[i]);
        myViewHolder.txtdesc.setText(this.f56a[i]);
    }

    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(this, this, this.inflater.inflate(R.layout.realocation_calllocator_item2, viewGroup, false));
    }
}
