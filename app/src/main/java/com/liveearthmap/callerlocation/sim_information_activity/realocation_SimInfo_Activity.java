...
public class realocation_SimInfo_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_sim_info_layout);

        ((ImageView) findViewById(R.id.img_back)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_SimInfo_Activity.this.onBackPressed();
            }
        });

        context = realocation_SimInfo_Activity.this;
