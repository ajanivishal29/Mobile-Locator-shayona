package com.liveearthmap.callerlocation.isd_activity;
...
import com.liveearthmap.callerlocation.std_code_activity.DataBaseHelper_std;

import java.util.ArrayList;
import java.util.Locale;

public class realocation_CodeList_ISD extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_isd_codes_list_layout);
        /*try {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                realocation_CodeList_ISD.this.adapter.filter(realocation_CodeList_ISD.this.editsearch.getText().toString().toLowerCase(Locale.getDefault()));
            }
        });
    }
