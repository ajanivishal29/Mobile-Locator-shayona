package com.liveearthmap.callerlocation.recharge_activity;
...
public class realocation_Rechargee_Activity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            Collection filter = Collections2.filter(realocation_Rechargee_Activity.mContentItems, new Predicate<R_Plan>() {
                /* class com.findlocation.callerlocation.recharge_activity.Rechargee_Activity.PlaceholderFragment.AnonymousClass1 */
...
//                    return Predicate.CC.$default$test(this, r_Plan);
                ...
                public boolean apply(R_Plan r_Plan) {
                    return r_Plan.getCategory().contains(realocation_Rechargee_Activity.type[PlaceholderFragment.this.getArguments().getInt(PlaceholderFragment.ARG_SECTION_NUMBER) - 1]);
                }
            });
            this.arr_filteredlist.clear();
            this.arr_filteredlist = new ArrayList(filter);
            realocation_Rechargee_Activity.callLocatorRvAdapter = new RV_Adapter(getActivity(), this.arr_filteredlist);
            recyclerView.setAdapter(realocation_Rechargee_Activity.callLocatorRvAdapter);
            realocation_Rechargee_Activity.callLocatorRvAdapter.notifyDataSetChanged();
            return inflate;
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public CharSequence getPageTitle(int i) {
            return realocation_Rechargee_Activity.this.tabname[i];
        }
    }

    public realocation_Rechargee_Activity() {
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.realocation_recharge_layout);
        ...
        context = realocation_Rechargee_Activity.this;
    ...
    private void selectDialog() {
        @SuppressLint("WrongConstant") View inflate = ((LayoutInflater) getBaseContext().getSystemService("layout_inflater")).inflate(R.layout.realocation_spinner_layout, (ViewGroup) null);
        ...
        ((Button) inflate.findViewById(R.id.viewplan)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_Rechargee_Activity.operator = realocation_Rechargee_Activity.this.OperatorShort[spinner.getSelectedItemPosition()];
                realocation_Rechargee_Activity.circle1 = (String) spinner2.getSelectedItem();
                realocation_Rechargee_Activity.circle = realocation_Rechargee_Activity.this.StateShort[spinner2.getSelectedItemPosition()];
                if (realocation_Rechargee_Activity.this.getSupportActionBar() != null) {
                    ActionBar supportActionBar = realocation_Rechargee_Activity.this.getSupportActionBar();
                    supportActionBar.setTitle((CharSequence) ((CharSequence) spinner.getSelectedItem()) + " - " + realocation_Rechargee_Activity.circle1);
                }
                realocation_Rechargee_Activity.this.getPlans();
                show.dismiss();
            }
        });
    }
    ...
    public void getPlans() {
        ...
        newRequestQueue.add(new StringRequest(0, getResources().getString(R.string.url) + "?circle=" + circle + "&service=" + operator + "&uid=16917f21-e786-477c-92bd-7db805153d90", new Response.Listener<String>() {
            public void onResponse(String str) {
                JSONArray jSONArray;
                realocation_Rechargee_Activity.mContentItems.clear();
                try {
                ...
                if (jSONArray2 != null) {
                    realocation_Rechargee_Activity.this.simpleProgressBar.setVisibility(8);
                    for (int i = 0; i < jSONArray2.length(); i++) {
                        ...
                        try {
                            ...
                            realocation_Rechargee_Activity.mContentItems.add(new R_Plan(string, string2, string3, string4, string5, str2, jSONArray2.getJSONObject(i).getString("keywords")));
                        } catch (JSONException e2) {
                            e2.printStackTrace();
                        }
                    }
                }
                if (realocation_Rechargee_Activity.mContentItems.size() == 0) {
                    Toast.makeText(realocation_Rechargee_Activity.this, " Service Not Available in selected circle.", 1).show();
                }
                realocation_Rechargee_Activity.this.mViewPager.setAdapter(realocation_Rechargee_Activity.this.mSectionsPagerAdapter);
            }
