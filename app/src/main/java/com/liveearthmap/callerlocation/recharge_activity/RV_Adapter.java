...
public class RV_Adapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new RPViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.realocation_card_picture, viewGroup, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        try {
            ...
            rPViewHolder.itemprice.setBackground(this.service.getDrawable(Integer.parseInt(this.circlej.getString(realocation_Rechargee_Activity.operator))));
        } catch (JSONException e) {
            e.printStackTrace();
        }
