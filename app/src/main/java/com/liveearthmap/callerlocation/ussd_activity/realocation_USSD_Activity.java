package com.liveearthmap.callerlocation.ussd_activity;
...
public class realocation_USSD_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_ussd1_layout);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle((CharSequence) "USSD Codes");
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        context = realocation_USSD_Activity.this;
            ...
            public void onResponse(String str) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ArrayList<String> arrayList = realocation_USSD_Activity.this.list;
                        arrayList.add(realocation_USSD_Activity.this.Operator[i] + ": ");
                        ...
                        for (int i2 = 0; i2 < length; i2++) {
                            ArrayList<String> arrayList2 = realocation_USSD_Activity.this.list;
                            arrayList2.add(jSONArray2.getString(i2) + ":" + jSONArray3.getString(i2));
                        }
                    }
                    ListView listView = realocation_USSD_Activity.this.listView;
                    realocation_USSD_Activity uSSD_Activity = realocation_USSD_Activity.this;
