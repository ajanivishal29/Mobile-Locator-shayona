...
import com.liveearthmap.callerlocation.Main_Ads.RetrofitResponce.AdListResponsenew;
...
import com.liveearthmap.callerlocation.Main_Ads.admob_ads.Constant;
import com.liveearthmap.callerlocation.Main_Ads.admob_ads.Utils;
import com.liveearthmap.callerlocation.Main_Ads.admob_ads.realocation_Privacy_PolicyActivity;
...
import com.liveearthmap.callerlocation.activity.Converter;
...
public class realocation_Splace_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.realocation_activity_splash);

        apiInterface = APIClient.getClient().create(RetrofitInterface.class);

        Utils.saveStringtoPrefrence(realocation_Splace_Activity.this, Constant.AdResponse, null);
            ...
            public void onResponse(Call<AdListResponsenew> call, Response<AdListResponsenew> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (dataItemList != null && dataItemList.size() > 0) {
                        ...
                        Utils.saveStringtoPrefrence(realocation_Splace_Activity.this, Constant.AdResponse, favData);

                        convertedObject = Utils.getResponse(realocation_Splace_Activity.this);
                        ...
                        if (convertedObject != null) {
                            if (convertedObject.getCheckAdVpn().equalsIgnoreCase("on")) {
                                ...
                                if (convertedObject != null) {
                                    ...
                                    Adintermethod.getInstance(realocation_Splace_Activity.this).admob_nativebanner_load(realocation_Splace_Activity.this, convertedObject.getAdmobNativeid());
                                    Adintermethod.getInstance(realocation_Splace_Activity.this).admob_native_load(realocation_Splace_Activity.this, convertedObject.getAdmobNativeid());
                                    ...
                                    if (convertedObject.getCheckAdSplash().equals("admob")) {
                                        ...
                                        Intent i = new Intent(realocation_Splace_Activity.this, realocation_Privacy_PolicyActivity.class);
    ...
    class FirstReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(ACTION_CLOSE)) {
                realocation_Splace_Activity.this.finish();
            }
        }
    }
    ...
    private void getAdsLoad() {
        this.loadCallback = new AppOpenAd.AppOpenAdLoadCallback() {
            public void onAdLoaded(final AppOpenAd appOpenAd) {
                ...
                appOpenAd.show(realocation_Splace_Activity.this);
                appOpenAd.setFullScreenContentCallback(realocation_Splace_Activity.this.fullScreenContentCallback);
                AppOpenAd unused = realocation_Splace_Activity.this.appOpenAd = appOpenAd;
                    ...
                    new InterstitialAdLoadCallback() {
                        ...
                        public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                            ...
                            if (mInterstitialAd != null) {
                                mInterstitialAd.show(realocation_Splace_Activity.this);
                            }
        ...
        UnifiedSDK.getVpnState(new com.anchorfree.vpnsdk.callbacks.Callback<VPNState>() {
            public void success(VPNState vPNState) {
                switch (vPNState.ordinal()) {
                    case 1:
                        if (!connected) {
                            realocation_Splace_Activity uIActivity = realocation_Splace_Activity.this;
                            uIActivity.connected = true;
                            realocation_Splace_Activity uIActivity2 = realocation_Splace_Activity.this;
                        ...
                        realocation_Splace_Activity.this.hideConnectProgress();
                        return;
                    ...
                    case 4:
                    case 5:
                        realocation_Splace_Activity.this.showConnectProgress();
                        return;
                    case 6:
//                        Log.e(realocation_UIActivity.TAG, "success: PAUSED");
        ...
        getCurrentServer(new com.anchorfree.vpnsdk.callbacks.Callback<String>() {
            public void success(final String str) {
                realocation_Splace_Activity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        if (!str.equals("")) {
    ...
    public void checkRemainingTraffic() {
        UnifiedSDK.getInstance().getBackend().remainingTraffic(new com.anchorfree.vpnsdk.callbacks.Callback<RemainingTraffic>() {
            public void success(RemainingTraffic remainingTraffic) {
                realocation_Splace_Activity.this.updateRemainingTraffic(remainingTraffic);
            }

            public void failure(VpnException vpnException) {
                realocation_Splace_Activity.this.updateUI();
                realocation_Splace_Activity.this.handleError(vpnException);
            }
        });
    }
                ...
                if (vPNState == VPNState.CONNECTED) {
                    UnifiedSDK.getStatus(new com.anchorfree.vpnsdk.callbacks.Callback<SessionInfo>() {
                        public void success(SessionInfo sessionInfo) {
                            String unused = realocation_Splace_Activity.this.ServerIPaddress = sessionInfo.getCredentials().getServers().get(0).getAddress();
                            callback.success(CredentialsCompat.getServerCountry(sessionInfo.getCredentials()));
                        }

                        public void failure(VpnException vpnException) {
                            callback.success(realocation_Splace_Activity.this.selectedCountry);
                        }
                    });
                } else {
                    callback.success(realocation_Splace_Activity.this.selectedCountry);
