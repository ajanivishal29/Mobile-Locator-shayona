...
public class realocation_thankyou extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.realocation_activity_thankyou);

        context = realocation_thankyou.this;
        ...
        this.later.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_thankyou.this.rating_view.animate().alpha(0.0f);
            }
        });
        ...
        ((TextView) findViewById(R.id.exit_yes)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Adintermethod.getInstance(realocation_thankyou.this).clearprefrence(realocation_thankyou.this);
                finishAffinity();
            }
        });
        ((TextView) findViewById(R.id.exit_no)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                startActivity(new Intent(realocation_thankyou.this, realocation_Privacy_PolicyActivity.class));
            }
        });
    }
