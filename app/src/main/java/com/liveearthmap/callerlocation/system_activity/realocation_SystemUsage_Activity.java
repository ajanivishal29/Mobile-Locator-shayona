package com.liveearthmap.callerlocation.system_activity;
...
import com.liveearthmap.callerlocation.device_activity.BackgroundToForegroundTransformer;
import com.facebook.ads.NativeAdLayout;
import com.google.android.material.tabs.TabLayout;

public class realocation_SystemUsage_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_system_usage_layout);

        initview();
        ViewGroup viewGroup = null;
        View inflate = getLayoutInflater().inflate(R.layout.realocation_system_tablayout1, viewGroup, false);
        this.f120l1 = (LinearLayout) inflate.findViewById(R.id.l1);
        this.text1 = (TextView) inflate.findViewById(R.id.text1);
        View inflate2 = getLayoutInflater().inflate(R.layout.realocation_system_tablayout2, viewGroup, false);
        ...
        context = realocation_SystemUsage_Activity.this;
        ...
        this.tablayout.addOnTabSelectedListener((TabLayout.BaseOnTabSelectedListener) new TabLayout.BaseOnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                String str = realocation_SystemUsage_Activity.this.TAG;
                Log.e(str, "onTabSelected: " + tab.getPosition());
                tab.getPosition();
                tab.getPosition();
                realocation_SystemUsage_Activity.this.viewpager.setCurrentItem(tab.getPosition());
            }
        });
        ...
        this.ivback.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_SystemUsage_Activity.this.onBackPressed();
            }
        });
    }
