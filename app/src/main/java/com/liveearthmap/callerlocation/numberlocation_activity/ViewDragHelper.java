...
public class ViewDragHelper {
    ...
    private int computeSettleDuration(View view, int i, int i2, int i3, int i4) {
        ...
        return (int) ((((float) computeAxisDuration(i, clampMag, this.mCallback.getViewHorizontalDragRange(view))) * f5) + (((float) computeAxisDuration(i2, clampMag2, this.mCallback.getViewVerticalDragRange(view))) * (f4 / f3)));
    }
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            ...
            int i4 = this.mInitialEdgesTouched[pointerId3] & this.mTrackingEdges;
            if (i4 != 0) {
                this.mCallback.onEdgeTouched(i4, pointerId3);
            }
        }
        if (this.mDragState == 1) {
            return true;
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                ...
                if (this.mDragState == 0) {
                    ...
                    int i4 = this.mInitialEdgesTouched[pointerId2] & this.mTrackingEdges;
                    if (i4 != 0) {
                        this.mCallback.onEdgeTouched(i4, pointerId2);
                    }
                ...
                if (this.mDragState == 1 && pointerId3 == this.mActivePointerId) {
                    ...
                    while (true) {
                        ...
                        if (pointerId4 != this.mActivePointerId && findTopChildUnder((int) MotionEventCompat.getX(motionEvent, i2), (int) MotionEventCompat.getY(motionEvent, i2)) == (view = this.mCapturedView) && tryCaptureViewForDrag(view, pointerId4)) {
            ...
            while (i2 < pointerCount2) {
                ...
                if (this.mDragState != 1) {
                    View findTopChildUnder2 = findTopChildUnder((int) this.mInitialMotionX[pointerId5], (int) this.mInitialMotionY[pointerId5]);
                    if (checkTouchSlop(findTopChildUnder2, f, f2) && tryCaptureViewForDrag(findTopChildUnder2, pointerId5)) {
                        break;
                    }
                    i2++;
                } else {
