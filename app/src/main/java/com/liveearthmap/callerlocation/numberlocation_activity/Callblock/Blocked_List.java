package com.liveearthmap.callerlocation.numberlocation_activity.Callblock;
...
public class Blocked_List extends Activity {
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            View inflate = this.inflater.inflate(R.layout.realocation_blocked_list_items_layout, (ViewGroup) null);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.realocation_blocked_list_layout);
