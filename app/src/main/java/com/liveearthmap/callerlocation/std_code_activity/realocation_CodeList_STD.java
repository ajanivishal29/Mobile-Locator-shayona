package com.liveearthmap.callerlocation.std_code_activity;
...
public class realocation_CodeList_STD extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_std__codes__list_layout);
        /*try {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                realocation_CodeList_STD.this.adapter.filter(realocation_CodeList_STD.this.editsearch.getText().toString().toLowerCase(Locale.getDefault()));
            }
        });
    }
