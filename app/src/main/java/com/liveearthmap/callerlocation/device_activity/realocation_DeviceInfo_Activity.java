...
public class realocation_DeviceInfo_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_device_info_layout);

        initview();
        ViewGroup viewGroup = null;
        View inflate = getLayoutInflater().inflate(R.layout.realocation_device_tablayout1, viewGroup, false);
        this.f107l1 = (LinearLayout) inflate.findViewById(R.id.l1);
        this.text1 = (TextView) inflate.findViewById(R.id.text1);

        context = realocation_DeviceInfo_Activity.this;
        ...
        View inflate2 = getLayoutInflater().inflate(R.layout.realocation_device_tablayout2, viewGroup, false);
        ...
        this.tablayout.addOnTabSelectedListener((TabLayout.BaseOnTabSelectedListener) new TabLayout.BaseOnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                tab.getPosition();
                tab.getPosition();
                realocation_DeviceInfo_Activity.this.viewpager.setCurrentItem(tab.getPosition());
            }
        });
