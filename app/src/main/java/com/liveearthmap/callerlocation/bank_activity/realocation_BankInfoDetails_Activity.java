...
public class realocation_BankInfoDetails_Activity extends AppCompatActivity {
    String balance;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_bankinfodetails_layout);
        ...
        context = realocation_BankInfoDetails_Activity.this;
        ...
        this.sharebalancenumber.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("android.intent.extra.TEXT", realocation_BankInfoDetails_Activity.this.title + " to check the bank balance findlocation is :---" + realocation_BankInfoDetails_Activity.this.balance);
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
        ...
        this.sharecustomernumber.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent("android.intent.action.SEND");
                intent.setType("text/plain");
                intent.putExtra("android.intent.extra.TEXT", realocation_BankInfoDetails_Activity.this.title + " to check the customercare findlocation is :---" + realocation_BankInfoDetails_Activity.this.customer);
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
                bankInfoDetails_Activity.startActivity(Intent.createChooser(intent, bankInfoDetails_Activity.getResources().getText(R.string.app_name)));
            }
        });
        this.sharestatementnumber.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent("android.intent.action.SEND");
                intent.setType("text/plain");
                intent.putExtra("android.intent.extra.TEXT", realocation_BankInfoDetails_Activity.this.title + " to check the ministatement findlocation is :---" + realocation_BankInfoDetails_Activity.this.statement);
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
                bankInfoDetails_Activity.startActivity(Intent.createChooser(intent, bankInfoDetails_Activity.getResources().getText(R.string.app_name)));
            }
        });
        ...
        this.balancephonecall.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
                bankInfoDetails_Activity.startActivity(new Intent("android.intent.action.DIAL", Uri.parse("tel:" + realocation_BankInfoDetails_Activity.this.balance)));
            }
        });
        this.customerphonecall.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
                bankInfoDetails_Activity.startActivity(new Intent("android.intent.action.DIAL", Uri.parse("tel:" + realocation_BankInfoDetails_Activity.this.customer)));
            }
        });
        this.ministatemenphonecall.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                realocation_BankInfoDetails_Activity bankInfoDetails_Activity = realocation_BankInfoDetails_Activity.this;
                bankInfoDetails_Activity.startActivity(new Intent("android.intent.action.DIAL", Uri.parse("tel:" + realocation_BankInfoDetails_Activity.this.statement)));
            }
        });
    }
