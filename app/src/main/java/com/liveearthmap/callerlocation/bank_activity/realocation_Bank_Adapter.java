...
public class realocation_Bank_Adapter extends RecyclerView.Adapter<realocation_Bank_Adapter.BankHolder> {
    Context mContext;
    ...
    public realocation_Bank_Adapter(Context context, ArrayList<realocation_Bank_Modelclass> arrayList) {
    ...
    public void onBindViewHolder(BankHolder bankHolder, int i) {
        ...
        bankHolder.bankViewName.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(realocation_Bank_Adapter.this.mContext, realocation_BankInfoDetails_Activity.class);
                intent.putExtra("title", title);
                intent.putExtra("balance", balance);
                intent.putExtra("customer", customer);
                intent.putExtra("statement", statement);
                intent.putExtra("img", img);
                realocation_Bank_Adapter.this.mContext.startActivity(intent);
            }
        });
    }
