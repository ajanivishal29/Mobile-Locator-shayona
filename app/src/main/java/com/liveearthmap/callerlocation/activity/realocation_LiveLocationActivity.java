...
public class realocation_LiveLocationActivity extends realocation_LocationBaseActivity implements OnMapReadyCallback {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.LiveLocationActivity$a */
    public class C1656a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            realocation_LiveLocationActivity.this.onBackPressed();
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        View inflate = getLayoutInflater().inflate(R.layout.realocation_activity_live_location, (ViewGroup) null, false);

        gpsTracker = new realocation_GPSTracker(realocation_LiveLocationActivity.this);
        ...
        context = realocation_LiveLocationActivity.this;
...
//            this.f6357r.mo15193f().mo15246b(new C6175f(this));
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(realocation_LiveLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(realocation_LiveLocationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
