...
public class realocation_Web_pp extends AppCompatActivity {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.Startup.FFskin_Web_pp$a */
    public class C1703a extends WebChromeClient {
        public C1703a() {
        }

        public void onProgressChanged(WebView webView, int i) {
            realocation_Web_pp.this.setProgress(i * 100);
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.Startup.FFskin_Web_pp$b */
    public class C1704b implements View.OnClickListener {
        public C1704b() {
        }

        public void onClick(View view) {
            realocation_Web_pp.this.onBackPressed();
        }
    }
