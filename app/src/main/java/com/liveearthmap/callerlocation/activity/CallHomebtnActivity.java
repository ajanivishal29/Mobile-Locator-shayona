...
import com.liveearthmap.callerlocation.realocation_HomePage_Activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.live_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CallHomebtnActivity.this, realocation_HomePage_Activity.class));
                finish();
            }
        });
