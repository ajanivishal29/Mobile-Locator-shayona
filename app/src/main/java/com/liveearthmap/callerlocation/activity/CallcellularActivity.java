...
public class CallcellularActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_callcellular);

        context = CallcellularActivity.this;
        ...
        findViewById(R.id.im1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CallcellularActivity.this, CallHomebtnActivity.class));
            }
        });
