...
public class realocation_CompassActivityActivity extends realocation_LocationBaseActivity implements SensorEventListener, OnMapReadyCallback {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null || !location.equals("")) {
            Log.d("callerlocation", location.toString());
...
//        Log.d("callerlocation", googleMap.toString());
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.CompassActivityActivity$a */
    public class C1642a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            realocation_CompassActivityActivity.this.onBackPressed();
        }
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        View inflate = getLayoutInflater().inflate(R.layout.realocation_activity_compass_activity, (ViewGroup) null, false);

        gpsTracker = new realocation_GPSTracker(realocation_CompassActivityActivity.this);
        ...
        context = realocation_CompassActivityActivity.this;
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(realocation_CompassActivityActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(realocation_CompassActivityActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
