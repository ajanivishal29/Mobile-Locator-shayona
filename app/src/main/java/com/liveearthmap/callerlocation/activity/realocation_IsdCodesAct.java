...
public class realocation_IsdCodesAct extends AppCompatActivity {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$a */
    public class C1650a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            realocation_IsdCodesAct.this.onBackPressed();
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$b */
    public class C1651b implements View.OnClickListener {

        /* renamed from: c */
        public realocation_IsdCodesAct f6347c;

        public C1651b(realocation_IsdCodesAct isdCodesAct) {
        ...
        public void onClick(View view) {
            ...
            realocation_IsdCodesAct isdCodesAct = realocation_IsdCodesAct.this;
            isdCodesAct.f6331C = true;
            isdCodesAct.f6336q.setVisibility(0);
            realocation_IsdCodesAct.this.f6337r.setVisibility(8);
            realocation_IsdCodesAct.this.f6342w.setVisibility(8);
            realocation_IsdCodesAct.this.f6340u.setText("");
            realocation_IsdCodesAct.this.f6340u.setHint("Enter Country Name");
            realocation_IsdCodesAct.this.f6340u.setInputType(1);
            this.f6347c.mo7136I();
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$c */
    public class C1652c implements View.OnClickListener {

        /* renamed from: c */
        public realocation_IsdCodesAct f6349c;

        public C1652c(realocation_IsdCodesAct isdCodesAct) {
        ...
        public void onClick(View view) {
            ...
            realocation_IsdCodesAct.this.f6336q.setVisibility(8);
            realocation_IsdCodesAct.this.f6342w.setVisibility(8);
            realocation_IsdCodesAct.this.f6340u.setText("");
            realocation_IsdCodesAct.this.f6340u.setInputType(2);
            realocation_IsdCodesAct.this.f6340u.setHint("Enter ISD Code");
            realocation_IsdCodesAct isdCodesAct2 = this.f6349c;
            Objects.requireNonNull(isdCodesAct2);
            while (true) {
                String[] strArr = realocation_IsdCodesAct.f6327G;
                if (i < strArr.length) {
                    isdCodesAct2.f6332D.put(strArr[i], realocation_IsdCodesAct.f6328H[i]);
                    isdCodesAct2.f6332D.size();
                    ArrayAdapter arrayAdapter = new ArrayAdapter(isdCodesAct2, R.layout.text, realocation_IsdCodesAct.f6327G);
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$d */
    public class C1653d implements View.OnClickListener {

        /* renamed from: c */
        public realocation_IsdCodesAct f6351c;

        public C1653d(realocation_IsdCodesAct isdCodesAct) {
        ...
        public void onClick(View view) {
            ...
            realocation_IsdCodesAct isdCodesAct2 = this.f6351c;
            ...
            if (z) {
                ...
                try {
                    realocation_IsdCodesAct isdCodesAct3 = this.f6351c;
                    isdCodesAct3.f6329A.setText(isdCodesAct3.f6334F.toString());
                    realocation_IsdCodesAct isdCodesAct4 = this.f6351c;
                    ...
                    realocation_IsdCodesAct.this.f6335p = false;
                ...
                realocation_IsdCodesAct isdCodesAct5 = this.f6351c;
                isdCodesAct5.f6329A.setText(isdCodesAct5.f6333E.toString());
                realocation_IsdCodesAct isdCodesAct6 = this.f6351c;
                isdCodesAct6.f6330B.setText(isdCodesAct6.f6332D.get(isdCodesAct6.f6329A.getText().toString()));
                this.f6351c.f6342w.setVisibility(0);
                realocation_IsdCodesAct.this.f6335p = true;
            }
            boolean z2 = realocation_IsdCodesAct.this.f6335p;
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$e */
    public class C1654e implements AdapterView.OnItemClickListener {

        /* renamed from: c */
        public realocation_IsdCodesAct f6353c;

        public C1654e(realocation_IsdCodesAct isdCodesAct, realocation_IsdCodesAct isdCodesAct2) {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.IsdCodesAct$f */
    public class C1655f implements AdapterView.OnItemClickListener {

        /* renamed from: c */
        public realocation_IsdCodesAct f6354c;

        public C1655f(realocation_IsdCodesAct isdCodesAct, realocation_IsdCodesAct isdCodesAct2) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_activity_isd_codes);
        ...
        context = realocation_IsdCodesAct.this;
