...
public class realocation_StdCodesAct extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    /* renamed from: C */
    public HashMap<String, String> hashmao_array;

    /* renamed from: E */
    public ConstraintLayout constraintlayout;

    /* renamed from: q */
    public TextView f6473q;
    ...
    /* renamed from: w */
    public TextView std_code;

    /* renamed from: x */
    public TextView tv_cityname;

    /* renamed from: y */
    public TextView tv_stdcode;
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.StdCodesAct$b */
    public class C1723b implements View.OnClickListener {
        public C1723b() {
        }
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.StdCodesAct$c */
    public class C1724c implements View.OnClickListener {
        public C1724c() {
        }
        ...
        public void onClick(View view) {
            TextView textView;
            realocation_StdCodesAct.m4620J(realocation_StdCodesAct.this);
            if (realocation_StdCodesAct.this.autocompletetextview.getText().toString().equals((Object) null) || realocation_StdCodesAct.this.autocompletetextview.getText().toString().equals("")) {
                Toast.makeText(realocation_StdCodesAct.this, "Select Value", 0).show();
                realocation_StdCodesAct.this.constraintlayout.setVisibility(8);
                return;
            }
            realocation_StdCodesAct.this.constraintlayout.setVisibility(0);
            realocation_StdCodesAct.this.tv_cityname.setText("City Name:");
            realocation_StdCodesAct.this.tv_stdcode.setText("STD Code:");
            CharSequence charSequence = "Unknown";
            if (Arrays.asList(realocation_StdCodesAct.f6465F).contains(realocation_StdCodesAct.this.autocompletetextview.getText().toString().trim())) {
                realocation_StdCodesAct stdCodesAct = realocation_StdCodesAct.this;
                stdCodesAct.city_name.setText(stdCodesAct.f6482z);
                realocation_StdCodesAct stdCodesAct2 = realocation_StdCodesAct.this;
                textView = stdCodesAct2.std_code;
                charSequence = stdCodesAct2.hashmao_array.get(stdCodesAct2.city_name.getText().toString());
            } else {
                realocation_StdCodesAct.this.std_code.setText(charSequence);
                textView = realocation_StdCodesAct.this.city_name;
            }
            textView.setText(charSequence);
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.StdCodesAct$d */
    public class C1725d implements View.OnClickListener {
        public C1725d() {
        }

        @SuppressLint({"ResourceAsColor", "WrongConstant", "UseCompatLoadingForDrawables"})
        public void onClick(View view) {
            try {
                realocation_StdCodesAct.this.view1.setVisibility(8);
                realocation_StdCodesAct.this.view2.setVisibility(0);
                realocation_StdCodesAct.this.autocompletetextview.setText((CharSequence) null);
                realocation_StdCodesAct.this.autocompletetextview.setHint("Enter STD Code");
                realocation_StdCodesAct.this.constraintlayout.setVisibility(8);
                realocation_StdCodesAct.this.autocompletetextview.setInputType(2);
                realocation_StdCodesAct.this.mo7233K();
            } catch (Exception unused) {
            }
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.StdCodesAct$e */
    public class C1726e implements View.OnClickListener {
        public C1726e() {
        }
        ...
        public void onClick(View view) {
            ...
            realocation_StdCodesAct.this.tv_stdcode.setText("STD Code:");
            CharSequence charSequence = "Unknown";
            if (Arrays.asList(realocation_StdCodesAct.f6466G).contains(realocation_StdCodesAct.this.autocompletetextview.getText().toString().trim())) {
                realocation_StdCodesAct stdCodesAct = realocation_StdCodesAct.this;
                stdCodesAct.std_code.setText(stdCodesAct.f6467A);
                realocation_StdCodesAct stdCodesAct2 = realocation_StdCodesAct.this;
                textView = stdCodesAct2.city_name;
                charSequence = stdCodesAct2.hashmao_array.get(stdCodesAct2.std_code.getText().toString());
            } else {
                realocation_StdCodesAct.this.std_code.setText(charSequence);
                textView = realocation_StdCodesAct.this.city_name;
            }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.realocation_activity_std_codes);

        autocompletetextview = findViewById(R.id.autoCompleteTextView1);

        constraintlayout = findViewById(R.id.rel2);
        view1 = findViewById(R.id.txtbutton1);
        view2 = findViewById(R.id.txtbutton2);

        tv_cityname = findViewById(R.id.fra_std_code_textView2);
        tv_stdcode = findViewById(R.id.fra_std_code_textView4);
        iv_serach = findViewById(R.id.button3);
        city_name = findViewById(R.id.fra_std_code_textView3);
        std_code = findViewById(R.id.fra_std_code_textView5);
        ...
        context = realocation_StdCodesAct.this;
        ...
        findViewById(R.id.button1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                realocation_StdCodesAct.this.mo7232I();
            }
        });
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                realocation_StdCodesAct.this.onBackPressed();
            }
        });
    ...
    /* renamed from: J */
    public static void m4620J(Activity activity) {
    ...
    public void mo7232I() {
        ...
        realocation_StdCodesAct.this.view2.setVisibility(8);
        realocation_StdCodesAct.this.view1.setVisibility(0);
        realocation_StdCodesAct.this.autocompletetextview.setText((CharSequence) null);
        realocation_StdCodesAct.this.autocompletetextview.setHint("Enter City Name");
        realocation_StdCodesAct.this.constraintlayout.setVisibility(8);
        realocation_StdCodesAct.this.autocompletetextview.setInputType(1);
        int i = 0;
        while (true) {
            String[] strArr = f6465F;
            if (i < strArr.length) {
                this.hashmao_array.put(strArr[i], f6466G[i]);
                this.hashmao_array.size();
                Log.v("" + f6465F.length, "Selected city");
                ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.text, f6465F);
                arrayAdapter.setDropDownViewResource(R.layout.text);
                this.autocompletetextview.setThreshold(1);
                this.autocompletetextview.setAdapter(arrayAdapter);
                this.autocompletetextview.setOnItemClickListener(this);
                this.iv_serach.setOnClickListener(new C1724c());
//                this.f6473q.setOnClickListener(new C1725d());
                i++;
            } else {
                return;
            }
    ...
    public void mo7233K() {
        int i = 0;
        while (true) {
            String[] strArr = f6466G;
            if (i < strArr.length) {
                this.hashmao_array.put(strArr[i], f6465F[i]);
                this.hashmao_array.size();
                ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.text, f6466G);
                arrayAdapter.setDropDownViewResource(R.layout.text);
                this.autocompletetextview.setThreshold(1);
                this.autocompletetextview.setAdapter(arrayAdapter);
                this.autocompletetextview.setOnItemClickListener(this);
                this.iv_serach.setOnClickListener(new C1726e());
                i++;
            } else {
                return;
            }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        this.f6482z = (String) adapterView.getItemAtPosition(i);
        this.f6467A = (String) adapterView.getItemAtPosition(i);
    }
