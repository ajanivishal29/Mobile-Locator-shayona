...
public class realocation_GPSTimeActivityActivity extends realocation_LocationBaseActivity implements OnMapReadyCallback {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.GPSTimeActivityActivity$a */
    public class C1649a implements View.OnClickListener {
        public C1649a() {
        }

        public void onClick(View view) {
            realocation_GPSTimeActivityActivity.this.onBackPressed();
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        View inflate = getLayoutInflater().inflate(R.layout.realocation_activity_gpstime_activity, (ViewGroup) null, false);
        gpsTracker = new realocation_GPSTracker(realocation_GPSTimeActivityActivity.this);
        ...
        context = realocation_GPSTimeActivityActivity.this;
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(realocation_GPSTimeActivityActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(realocation_GPSTimeActivityActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
