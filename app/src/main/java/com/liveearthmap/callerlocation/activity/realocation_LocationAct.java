...
public class realocation_LocationAct extends realocation_LocationBaseActivity implements OnMapReadyCallback {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.LocationAct$a */
    public class C1661a implements View.OnClickListener {
        public C1661a() {
        }

        public void onClick(View view) {
            realocation_LocationAct.this.onBackPressed();
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.realocation_activity_location);
        ...
        gpsTracker = new realocation_GPSTracker(realocation_LocationAct.this);

        context = realocation_LocationAct.this;
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(realocation_LocationAct.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(realocation_LocationAct.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
