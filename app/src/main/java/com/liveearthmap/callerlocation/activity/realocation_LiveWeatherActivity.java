...
import com.liveearthmap.callerlocation.Main_Ads.RetrofitResponce.WeatherapiResponse;
import com.liveearthmap.callerlocation.Main_Ads.admob_ads.Adintermethod;
import com.liveearthmap.callerlocation.Main_Ads.retrofit.APIClient;
import com.liveearthmap.callerlocation.Main_Ads.retrofit.RetrofitInterface;
...
public class realocation_LiveWeatherActivity extends AppCompatActivity {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.LiveWeatherActivity$a */
    public class C1659a implements View.OnClickListener {
        public C1659a() {
        }

        public void onClick(View view) {
            realocation_LiveWeatherActivity.this.onBackPressed();
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.LiveWeatherActivity$b */
    ...
    public void onCreate(Bundle bundle) {
        ...
        View inflate = getLayoutInflater().inflate(R.layout.realocation_activity_live_weather, (ViewGroup) null, false);
        ...
        context = realocation_LiveWeatherActivity.this;
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        ...
                        if (Build.VERSION.SDK_INT >= 26) {
                            realocation_LiveWeatherActivity.this.f6363p = Calendar.getInstance();
                            realocation_LiveWeatherActivity.this.f6364q = new SimpleDateFormat("HH:mm:ss");
                            realocation_LiveWeatherActivity.this.f6365r = new SimpleDateFormat("dd-MM-yyyy");
                            realocation_LiveWeatherActivity liveWeatherActivity = realocation_LiveWeatherActivity.this;
                            liveWeatherActivity.f6366s = liveWeatherActivity.f6364q.format(liveWeatherActivity.f6363p.getTime());
                            realocation_LiveWeatherActivity liveWeatherActivity2 = realocation_LiveWeatherActivity.this;
                            ...
                            sb3.append(realocation_LiveWeatherActivity.this.f6366s);
                            Log.e("LiveWeatherActivity", sb3.toString());
                            StringBuilder sb4 = new StringBuilder();
                            sb4.append("onSuccess:+-+-+- ");
                            sb4.append(realocation_LiveWeatherActivity.this.f6367t);
                            ...
                            String str5 = str2;
                            sb10.append(str5);
                            TextView textView = realocation_LiveWeatherActivity.this.f6368u.f27763d;
                            ...
                            TextView textView2 = realocation_LiveWeatherActivity.this.f6368u.f27765f;
                            textView2.setText(str6 + realocation_LiveWeatherActivity.this.f6367t);
                            TextView textView3 = realocation_LiveWeatherActivity.this.f6368u.f27772m;
                            textView3.setText(str6 + realocation_LiveWeatherActivity.this.f6366s);
                            TextView textView4 = realocation_LiveWeatherActivity.this.f6368u.f27771l;
                            textView4.setText(str6 + format2 + str5);
                            TextView textView5 = realocation_LiveWeatherActivity.this.f6368u.f27775p;
                            textView5.setText(str6 + aVar2.getWeather().get(0).getDescription());
                            TextView textView6 = realocation_LiveWeatherActivity.this.f6368u.f27769j;
                            textView6.setText(str6 + realocation_LiveWeatherActivity.this.mo7150I(Instant.ofEpochSecond(Long.valueOf(aVar2.getSys().getSunrise()).longValue())));
                            TextView textView7 = realocation_LiveWeatherActivity.this.f6368u.f27770k;
                            textView7.setText(str6 + realocation_LiveWeatherActivity.this.mo7150I(Instant.ofEpochSecond(Long.valueOf(aVar2.getSys().getSunset()).longValue())));
                            TextView textView8 = realocation_LiveWeatherActivity.this.f6368u.f27767h;
                            textView8.setText(str6 + aVar2.getMain().getHumidity() + "%");
                            TextView textView9 = realocation_LiveWeatherActivity.this.f6368u.f27774o;
                            textView9.setText(str6 + aVar2.getWind().getSpeed() + "m/h");
                            TextView textView10 = realocation_LiveWeatherActivity.this.f6368u.f27768i;
                            textView10.setText(str6 + aVar2.getMain().getPressure() + " hPa");
                            TextView textView11 = realocation_LiveWeatherActivity.this.f6368u.f27764e;
                            textView11.setText(str6 + aVar2.getClouds().getAll() + " %");
                            TextView textView12 = realocation_LiveWeatherActivity.this.f6368u.f27773n;
                            textView12.setText(str6 + aVar2.getVisibility() + str4);
                            TextView textView13 = realocation_LiveWeatherActivity.this.f6368u.f27766g;
