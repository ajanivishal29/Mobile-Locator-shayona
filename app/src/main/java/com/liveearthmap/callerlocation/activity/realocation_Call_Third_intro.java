...
public class realocation_Call_Third_intro extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_call_third_intro);

        context = realocation_Call_Third_intro.this;
        ...
        findViewById(R.id.continue_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                realocation_Call_Third_intro.this.startActivity(new Intent(realocation_Call_Third_intro.this, realocation_TaptoStart.class));
            }
        });
    }
}
