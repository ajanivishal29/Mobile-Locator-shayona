...
public class realocation_NumberLocatorOpenAct extends AppCompatActivity {
    ...
    /* renamed from: com.loctracker.findlocation.callerlocation.NumberLocatorOpenAct$a */
    public class C1682a implements View.OnClickListener {
        public C1682a() {
        }

        public void onClick(View view) {
            realocation_NumberLocatorOpenAct.this.onBackPressed();
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.NumberLocatorOpenAct$b */
    public class C1683b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (realocation_NumberLocatorOpenAct.this.f6416w.getText().toString().equals("")) {
                Toast.makeText(realocation_NumberLocatorOpenAct.this, "Please enter Number", 0).show();
                return;
            }
            realocation_NumberLocatorOpenAct numberLocatorOpenAct = realocation_NumberLocatorOpenAct.this;
            StringBuilder w = m6209w("tel:");
            w.append(realocation_NumberLocatorOpenAct.this.f6416w.getText().toString().trim());
            numberLocatorOpenAct.startActivity(new Intent("android.intent.action.DIAL", Uri.parse(w.toString())));
        }
    }

    /* renamed from: com.loctracker.findlocation.callerlocation.NumberLocatorOpenAct$c */
    public class C1684c implements View.OnClickListener {

        /* renamed from: com.loctracker.findlocation.callerlocation.NumberLocatorOpenAct$c$a */
        public class C1685a implements Runnable {
            ...
            public void run() {
                ...
                realocation_NumberLocatorOpenAct numberLocatorOpenAct2 = realocation_NumberLocatorOpenAct.this;
                ...
                if (obj == null || obj.length() <= 5) {
                    ...
                    if (str3.length() < 2 || str4.length() < 2) {
                        ...
                        Log.d("StaticFragment", "cheack callerlocation " + bVar.mo16773a(str2).f27675a);
        ...
        public void onClick(View view) {
            try {
                if (realocation_NumberLocatorOpenAct.this.f6416w.getText().toString().length() == 10) {
                    ((InputMethodManager) realocation_NumberLocatorOpenAct.this.getSystemService("input_method")).hideSoftInputFromWindow(realocation_NumberLocatorOpenAct.this.getCurrentFocus().getWindowToken(), 0);
                    ProgressDialog progressDialog = new ProgressDialog(realocation_NumberLocatorOpenAct.this);
                    progressDialog.show();
                ...
                Toast.makeText(realocation_NumberLocatorOpenAct.this, R.string.Toast_on_enter_MobileNumber, 0).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public realocation_NumberLocatorOpenAct() {
        new ArrayList();
        this.f6419z = 5;
        this.f6400A = 1;
        this.f6401B = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.realocation_activity_number_locator_open);
        ...
        context = realocation_NumberLocatorOpenAct.this;
        ...
        String stringExtra2 = intent.getStringExtra("Location : callerlocation");
        ...
        LocationManager locationManager = (LocationManager) getSystemService("callerlocation");
