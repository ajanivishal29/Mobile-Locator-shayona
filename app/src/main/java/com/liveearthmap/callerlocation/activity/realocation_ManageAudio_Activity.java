...
public class realocation_ManageAudio_Activity extends AppCompatActivity {
    ImageView ivback;
...
//    public UnifiedNativeAd nativeAd;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.realocation_audiomanager_layout);

        context = realocation_ManageAudio_Activity.this;
        ...
        findViewById(R.id.img_ringtone).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Uri actualDefaultRingtoneUri = RingtoneManager.getActualDefaultRingtoneUri(realocation_ManageAudio_Activity.this, 1);
                ...
                realocation_ManageAudio_Activity.this.startActivityForResult(intent, 1001);
        ...
        findViewById(R.id.img_notification).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("android.intent.extra.ringtone.EXISTING_URI", RingtoneManager.getActualDefaultRingtoneUri(realocation_ManageAudio_Activity.this, 2));
                realocation_ManageAudio_Activity.this.startActivityForResult(intent, 1002);
            }
        });
        findViewById(R.id.img_alarm).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("android.intent.extra.ringtone.EXISTING_URI", RingtoneManager.getActualDefaultRingtoneUri(realocation_ManageAudio_Activity.this, 4));
                realocation_ManageAudio_Activity.this.startActivityForResult(intent, PointerIconCompat.TYPE_HELP);
            }
        });
    }
