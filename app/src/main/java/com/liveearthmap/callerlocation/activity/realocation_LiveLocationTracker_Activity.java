...
public class realocation_LiveLocationTracker_Activity extends BaseActivity implements View.OnClickListener {
    ...
    public int getContentView() {
        return R.layout.realocation_tracker_live_location_layout;
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);

        context = realocation_LiveLocationTracker_Activity.this;
        ...
        if (ContextCompat.checkSelfPermission(this, "android.permission.ACCESS_FINE_LOCATION") + ContextCompat.checkSelfPermission(this, "android.permission.ACCESS_COARSE_LOCATION") == 0) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    ActivityCompat.requestPermissions(realocation_LiveLocationTracker_Activity.this, new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}, 123);
                }
            });
        ...
        if (gPS_Tracker.isgpsenabled() && gPS_Tracker.canGetLocation()) {
            ...
            if (this.latitude == 0.0d) {
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        realocation_LiveLocationTracker_Activity.this.GetCurrent();
                    }
                }, 700);
            } else {
                GetCurrentAddress();
